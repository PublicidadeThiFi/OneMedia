...
import { inspectSpaDocumentResponse, isExpectedMountedSpaDocumentFallback, isExpectedSpaDocumentFallback } from './final-qa-lib.mjs';
...
const mountedState = { root: true, pathname: '/home', errorBoundary: false, loadingStuck: false };
assert.equal(isExpectedMountedSpaDocumentFallback({ status: 404, type: 'Document', url: 'https://onemediaap.com.br/home' }, 'https://onemediaap.com.br', mountedState, '/home'), true);
assert.equal(isExpectedMountedSpaDocumentFallback({ status: 404, type: 'Image', url: 'https://onemediaap.com.br/gifs/missing.gif' }, 'https://onemediaap.com.br', mountedState, '/home'), false);
assert.equal(isExpectedMountedSpaDocumentFallback({ status: 404, type: 'Document', url: 'https://onemediaap.com.br/home' }, 'https://onemediaap.com.br', { ...mountedState, root: false }, '/home'), false);
assert.equal(isExpectedMountedSpaDocumentFallback({ status: 404, type: 'Document', url: 'https://onemediaap.com.br/home' }, 'https://onemediaap.com.br', mountedState, '/outra'), false);
