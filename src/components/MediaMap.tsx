...
export function MediaMap() {
  ...
  return (
    ...
    >
        ...
        <div className="bg-white border rounded-xl shadow-sm p-3">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <Button
              ...
              size="sm"
              className={cn('h-8', layers.length === 0 ? 'mm-indigo' : '')}
              onClick={() => setLayers([])}
            >
              Todos
            </Button>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <Button
              ...
              size="sm"
              className={cn('h-8', drawMode === 'polygon' ? 'mm-indigo' : '')}
            ...
            <Button
              ...
              size="sm"
              className={cn('h-8', drawMode === 'rectangle' ? 'mm-indigo' : '')}
      ...
      {selectionPolygon ? (
      <div className="absolute bottom-4 left-4 right-4 bg-white border rounded-xl shadow-sm p-3" style={{ zIndex: 30, maxWidth: 520, pointerEvents: 'auto' }}>
