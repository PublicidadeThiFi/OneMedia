...
export function CashTransactionFormDialog({ open, onOpenChange, transaction, onSave }: CashTransactionFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      */}
      <DialogContent className="w-[min(860px,calc(100vw-1rem))] max-w-[860px] !p-0 !gap-0 overflow-hidden">
        <div className="border-b px-4 pt-4 pb-3 sm:px-6 sm:pt-6 sm:pb-4">
          <DialogHeader>
