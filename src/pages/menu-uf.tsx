        ...
        <div className="mt-5 rounded-[30px] border border-slate-200 bg-white/90 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.06)] backdrop-blur">
          <div className="grid gap-6 lg:grid-cols-[1fr_340px] lg:items-start">
            <div>
              ...
              <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-900">Escolha o estado onde você quer anunciar</h1>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            <div className="text-lg font-semibold text-slate-900">{item.uf}</div>
                        ...
                        <div className="mt-5 grid grid-cols-2 gap-3">
                          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3">
                            <div className="text-lg font-semibold text-slate-900">{item.citiesCount}</div>
                            <div className="mt-1 text-xs uppercase tracking-[0.12em] text-slate-500">Cidades</div>
                          </div>
                          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3">
                            <div className="text-lg font-semibold text-slate-900">{item.pointsCount}</div>
