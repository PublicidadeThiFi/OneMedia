    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-3xl shadow-xl mb-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Descrição do Serviço</h2>
                <p className="text-gray-700 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-3xl p-8 shadow-xl text-white">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-3">3. Período de Teste Gratuito</h2>
                <p className="leading-relaxed opacity-95 mb-4">
                  Oferecemos um período de teste gratuito de 30 dias com acesso completo à plataforma. 
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 mb-3">4. Uso Aceitável</h2>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Propriedade Intelectual</h2>
                <p className="text-gray-700 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. Limitação de Responsabilidade</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Card 7 - Modificações */}
          <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-3xl p-8 shadow-xl text-white">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center flex-shrink-0">
                <FileCheck className="w-6 h-6 text-white" />
              </div>
              <div>
                <h2 className="text-2xl font-semibold mb-3">7. Modificações dos Termos</h2>
