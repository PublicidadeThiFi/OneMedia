                  ...
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
                    <div>
                      ...
                      <div className="mt-1 max-w-2xl text-sm leading-6 text-slate-600">
                        Defina um período padrão para todo o pacote e depois refine item por item apenas quando for necessário.
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                {itemsEnriched.map(
                  ({
                    ...
                    <Card
                      key={item.id}
                      className="overflow-hidden rounded-[30px] border border-[#d9e7fb] bg-[#eef6ff] shadow-[0_16px_55px_rgba(15,23,42,0.06)]"
                    >
                      <CardContent className="p-4 sm:p-5">
                        <div className="flex flex-wrap items-center gap-2">
                          <Badge variant="outline" className="rounded-full border-[#d3def1] bg-white/85 px-3 text-slate-600">
                        ...
                        <div className="mt-4 grid gap-4 xl:grid-cols-[260px_minmax(0,1fr)] xl:items-start">
                          <div className="overflow-hidden rounded-[26px] border border-[#d7e4f8] bg-white">
                          ...
                          <div className="min-w-0 space-y-4">
                            <div className="space-y-2">
                              ...
                              {unitLabel ? <div className="menu-copy-wrap text-sm font-medium text-slate-700">{unitLabel}</div> : null}
                              {address ? (
                            ...
                            <div className="grid gap-3 lg:grid-cols-2">
                              <div className="rounded-[24px] border border-[#d7e4f8] bg-white px-4 py-4">
                            ...
                            <div className="rounded-[26px] border border-[#d7e4f8] bg-white px-4 py-4">
                              <div className="flex flex-wrap items-center gap-2">
              ...
              <Card className="menu-glass-card rounded-[30px]">
                <CardContent className="space-y-5 p-6">
                  <div>
                    ...
                    <div className="mt-1 text-sm leading-6 text-slate-600">
                      Conferência rápida do pacote antes de avançar para o checkout.
                    </div>
                  </div>
