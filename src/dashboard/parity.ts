...
export const DASHBOARD_PARITY_CHECKLIST: ParityItem[] = [
  ...
  {
    id: 'ops-dooh-summary',
    title: 'Operacoes / Resumo DOOH',
    description: 'Conferir telas, campanhas vinculadas e atividade recente no recorte.',
    route: DASHBOARD_BACKEND_ROUTES.doohSummary,
    fields: ['rows[].id', 'rows[].healthScorePercent', 'rows[].activeCampaignsCount', 'rows[].lastActivityAt'],
  },
];
